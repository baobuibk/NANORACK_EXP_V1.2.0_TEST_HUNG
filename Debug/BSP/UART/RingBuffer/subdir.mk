...
C_SRCS += \
../BSP/UART/RingBuffer/ring_buffer.c 

OBJS += \
./BSP/UART/RingBuffer/ring_buffer.o 

C_DEPS += \
./BSP/UART/RingBuffer/ring_buffer.d 


# Each subdirectory must supply rules for building sources it contributes
BSP/UART/RingBuffer/%.o BSP/UART/RingBuffer/%.su BSP/UART/RingBuffer/%.cyclo: ../BSP/UART/RingBuffer/%.c BSP/UART/RingBuffer/subdir.mk
...
clean: clean-BSP-2f-UART-2f-RingBuffer

clean-BSP-2f-UART-2f-RingBuffer:
	-$(RM) ./BSP/UART/RingBuffer/ring_buffer.cyclo ./BSP/UART/RingBuffer/ring_buffer.d ./BSP/UART/RingBuffer/ring_buffer.o ./BSP/UART/RingBuffer/ring_buffer.su

.PHONY: clean-BSP-2f-UART-2f-RingBuffer
