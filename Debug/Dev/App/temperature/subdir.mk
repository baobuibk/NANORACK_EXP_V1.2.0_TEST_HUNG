...
C_SRCS += \
../Dev/App/temperature/temperature.c 

OBJS += \
./Dev/App/temperature/temperature.o 

C_DEPS += \
./Dev/App/temperature/temperature.d 


# Each subdirectory must supply rules for building sources it contributes
Dev/App/temperature/%.o Dev/App/temperature/%.su Dev/App/temperature/%.cyclo: ../Dev/App/temperature/%.c Dev/App/temperature/subdir.mk
...
clean: clean-Dev-2f-App-2f-temperature

clean-Dev-2f-App-2f-temperature:
	-$(RM) ./Dev/App/temperature/temperature.cyclo ./Dev/App/temperature/temperature.d ./Dev/App/temperature/temperature.o ./Dev/App/temperature/temperature.su

.PHONY: clean-Dev-2f-App-2f-temperature
