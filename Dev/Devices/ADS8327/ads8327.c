...
void ADS8327_Device_Init(ADS8327_Device_t *dev, struct_init_typedef *param_init)
{
	...
	dev->spi = param_init->spi;
	dev->cs_port = param_init->cs_port;
	dev->cs_pin = param_init->cs_pin;
	dev->convst_port = param_init->convst_port;
	dev->convst_pin = param_init->convst_pin;
	dev->EOC_port = param_init->EOC_port;
	dev->EOC_pin = param_init->EOC_pin;
	dev->ADC_val = 0;
